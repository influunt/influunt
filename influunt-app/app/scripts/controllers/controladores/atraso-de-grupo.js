...
angular.module('influuntApp')
  .controller('ControladoresAtrasoDeGrupoCtrl', ['$scope', '$state', '$controller', 'assertControlador',
    function ($scope, $state, $controller, assertControlador) {
      ...
      // constroiTabelaOrigensEDestinos = function() {
      ...
      //   var allTransicoes = _.union($scope.objeto.transicoes, $scope.objeto.transicoesComPerdaDePassagem);
      //   allTransicoesGrupo.forEach(function(t) {
      //     var transicao = _.find(allTransicoes, { idJson: t.idJson });
      ...
      // getOrigemDestinoForTransicao = function(transicao) {
      //   transicao.origem = _.find($scope.objeto.estagios, { idJson: transicao.origem.idJson });
      //   transicao.origem.imagem = _.find($scope.objeto.imagens, { idJson: transicao.origem.imagem.idJson });
      //   transicao.destino = _.find($scope.objeto.estagios, { idJson: transicao.destino.idJson });
      //   transicao.destino.imagem = _.find($scope.objeto.imagens, { idJson: transicao.destino.imagem.idJson });
      // }
