...
describe('Controller: ControladoresDadosBasicosCtrl', function () {
  ...
  it('Deve criar o texto em "nomeEndereco" associando os nomes do "endereco 1" "x" "endereco 2"',
    inject(function($q, CTELocalizacaoService) {
      ...
      spyOn(CTELocalizacaoService, 'atualizaLatLngPorEndereco').and.returnValue(deferred.promise);
      deferred.resolve({lat: 1, lng: 2});

      scope.$apply();
      expect(CTELocalizacaoService.atualizaLatLngPorEndereco).toHaveBeenCalled();
