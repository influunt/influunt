  ...
  describe('Wizard para novo controlador', function() {
    ...
    describe('inicializaWizard', function() {
      it('Deve retornar o objeto vazio.', function() {
        expect(scope.objeto).toEqual({limiteEstagio: 16, limiteGrupoSemaforico: 16, limiteAnel: 4, limiteDetectorPedestre: 4, limiteDetectorVeicular: 8, limiteTabelasEntreVerdes: 2, enderecos: []});
      });
