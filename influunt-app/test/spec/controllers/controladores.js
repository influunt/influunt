    ...
    describe('marcarTransicaoAlternativa', function () {
      describe('Estágio E3 marcado como alternativa à transição proibida E1-E2', function() {
        ...
        it('Quando o estágio E3 é desmarcado como alternativa à transição E1-E2, a alternativa deverá ser removida dos hashes',
          function() {
            scope.marcarTransicaoAlternativa({origem: estagio1, destino: estagio2, alternativo: null});
            expect(estagio1.origemDeTransicoesProibidas[0].alternativo).not.toBeDefined();
          });
