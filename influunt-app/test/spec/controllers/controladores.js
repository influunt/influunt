  ...
  describe('Funções auxiliares', function () {
    ...
    describe('toggleTransicaoProibida', function () {
      beforeEach(function() {
        ...
        fakeInicializaWizard(scope, $q, objeto, scope.inicializaEstagiosProibidos);
      });
    ...
    describe('marcarTransicaoAlternativa', function () {
      describe('Estágio E3 marcado como alternativa à transição proibida E1-E2', function() {
        ...
        beforeEach(function() {
          ...
          scope.toggleTransicaoProibida(estagio1, estagio2, false);
          scope.marcarTransicaoAlternativa({origem: estagio1, destino: estagio2, alternativa: estagio3});
        });

        it('O campo alternativa E3 deverá ser adicionado à transição E1-E2 no hash de origemDeTransicoesProibidas de e1',
          function() {
            expect(estagio1.origemDeTransicoesProibidas[0].alternativa.id).toBe(estagio3.id);
          });

        it('O campo de alternativa E3 deverá ser adicionado à transição E1-E2 no hash de destinoDeTransicoesProibidas de e2',
          function() {
            expect(estagio2.destinoDeTransicoesProibidas[0].alternativa.id).toBe(estagio3.id);
          });

        it('O mesmo hash presente nas origemDeTransicoesProibidas e destinoDeTransicoesProibidas de E1 e E2 deverá estar presente' +
           ' no campo alternativaDeTransicoesProibidas de E3', function() {
            expect(estagio3.alternativaDeTransicoesProibidas[0]).toBe(estagio1.origemDeTransicoesProibidas[0]);
            expect(estagio3.alternativaDeTransicoesProibidas[0]).toBe(estagio2.destinoDeTransicoesProibidas[0]);
           });

        it('Quando o estágio E3 é desmarcado como alternativa à transição E1-E2, a alternativa deverá ser removida dos hashes',
          function() {
            scope.marcarTransicaoAlternativa({origem: estagio1, destino: estagio2, alternativa: null});
            expect(estagio1.origemDeTransicoesProibidas[0].alternativa).not.toBeDefined();
          });

        it('Quando o estágio E3 é desmarcado como alternativa à transição E1-E2, E3 não possui mais alternativa',
          function() {
            scope.marcarTransicaoAlternativa({origem: estagio1, destino: estagio2, alternativa: null});
