...
VALUES
  (@Controlador1Id,RANDOM_UUID(), @Croqui1Id, 'Av. Paulista com R. Bela Cintra',0,1,NULL,NULL,NULL,NULL,NULL, @ModeloId, @Area1Id,NULL, NOW(),NOW()),
  (@Controlador2Id,RANDOM_UUID(), @Croqui2Id, 'R. Bela Cintra com Av. Paulista',0,1,NULL,NULL,NULL,NULL,NULL, @ModeloId, @Area2Id,NULL, NOW(),NOW());
