...
Funcionalidade: Fluxo de cadastro de planos
  ...
  Cenário: Configurar um plano em modo coordenado
    ...
    E que o usuário marque 13 segundos para o "Tempo de Verde"
    E que o usuário clique no botão de fechar a caixa de configuração
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G1" com "indicacao-vermelho" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G1" com "indicacao-verde" em "14s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G1" com "indicacao-amarelo" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G1" com "indicacao-vermelho" em "30s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G2" com "indicacao-vermelho" em "20s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G2" com "indicacao-verde" em "14s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G2" com "indicacao-amarelo" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G2" com "indicacao-vermelho" em "13s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G3" com "indicacao-vermelho-intermitente" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G3" com "indicacao-vermelho" em "34s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G3" com "indicacao-verde" em "13s" segundos
    E que o usuário selecione o anel 2
    E que o usuário clicar no plano 2
    E que o usuário clique no botão de configurar o estágio "E1"
    E que o usuário marque 12 segundos para o "Tempo de Verde"
    ...
    E que o usuário marque 12 segundos para o "Tempo de Verde"
    E que o usuário clique no botão de fechar a caixa de configuração
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G4" com "indicacao-vermelho" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G4" com "indicacao-verde" em "12s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G4" com "indicacao-amarelo" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G4" com "indicacao-vermelho" em "12s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G5" com "indicacao-amarelo" em "3s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G5" com "indicacao-vermelho" em "15s" segundos
    Então o sistema deve mostar o diagrama "Coordenado" no grupo "G5" com "indicacao-verde" em "12s" segundos
  ...
  Cenário: Configurar um plano modo de operação intermitente
    ...
    Então o sistema exibe uma caixa de confirmação se o usuário deve mesmo excluir
    Quando o usuário responde sim
    Então o sistema deve mostar o diagrama "Intermitente" no grupo "G3" com "indicacao-intermitente" em "30s" segundos
    E o sistema deve mostar o diagrama "Intermitente" no grupo "G2" com "indicacao-intermitente" em "30s" segundos
    E o sistema deve mostar o diagrama "Intermitente" no grupo "G3" com "indicacao-intermitente" em "30s" segundos
    ...
    E que o usuário clicar no plano 3
    E que o usuário selecione o modo de operação "Intermitente"
    Então o sistema deve mostar o diagrama "Intermitente" no grupo "G4" com "indicacao-intermitente" em "30s" segundos
    E o sistema deve mostar o diagrama "Intermitente" no grupo "G5" com "indicacao-intermitente" em "30s" segundos
  ...
  Cenário: Configurar um plano modo de operação apagado
    ...
    Então o sistema exibe uma caixa de confirmação se o usuário deve mesmo excluir
    Quando o usuário responde sim
    Então o sistema deve mostar o diagrama "Apagado" no grupo "G1" com "indicacao-apagado" em "30s" segundos
    Então o sistema deve mostar o diagrama "Apagado" no grupo "G2" com "indicacao-apagado" em "30s" segundos
    Então o sistema deve mostar o diagrama "Apagado" no grupo "G3" com "indicacao-apagado" em "30s" segundos
    E o usuário não deve ter a opção de selecionar uma tabela entre verdes para o plano
    E o usuário não deve ter a opção de marcar o tempo de ciclo do estágio
    E o usuário não deve ter a opção de marcar a defasagem do ciclo
    Dado que o usuário selecione o anel 2
    E que o usuário clicar no plano 4
    E que o usuário selecione o modo de operação "Apagado"
    Então o sistema deve mostar o diagrama "Apagado" no grupo "G4" com "indicacao-apagado" em "30s" segundos
    Então o sistema deve mostar o diagrama "Apagado" no grupo "G5" com "indicacao-apagado" em "30s" segundos
  ...
  Cenário: Mostar erro ao tentar configurar atuado com verde intermediário maior
    Dado que o usuário esteja na página de planos
    E que o usuário selecione o anel 1
  ...
  Cenário: Mostar erro ao tentar configurar atuado com tempo de estágio maior tempo permanência
    E que o usuário clique no botão de configurar o estágio "E2"
