...
SET @CidadeId = UUID();
INSERT INTO `cidades` (`id`, `idJson`, `nome`, `data_criacao`, `data_atualizacao`) VALUES (@CidadeId, UUID(), 'São Paulo', NOW(), NOW());
INSERT INTO `areas` (`id`, `idJson`, `descricao`, `cidade_id`, `data_criacao`, `data_atualizacao`) VALUES (UUID(), UUID(), 1, @CidadeId, NOW(), NOW());

SET @FabricanteId = UUID();
INSERT INTO `fabricantes` (`id`, `idJson`, `nome`, `data_criacao`, `data_atualizacao`) VALUES (@FabricanteId, UUID(), 'Raro Labs', NOW(), NOW());
INSERT INTO `modelo_controladores` (`id`, `idJson`, `descricao`, `fabricante_id`, `data_criacao`, `data_atualizacao`) VALUES (UUID(), UUID(),'Modelo Básico', @FabricanteId, NOW(), NOW());
