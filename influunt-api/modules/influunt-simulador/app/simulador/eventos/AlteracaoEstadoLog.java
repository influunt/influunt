 ...
 */
public class AlteracaoEstadoLog extends DefaultLog {
    ...
    public String mensagem() {
        ...
        if (anterior != null) {
            return formatter.format("%s DE:%s PARA: %s ", prefix(), anterior.toString(), atual.toString()).toString();
        } else {
            return formatter.format("%s %s", prefix(), atual.toString()).toString();
        }
