...
/**
 * Created by lesiopinheiro on 18/10/16.
 */
public class HistoricoControladoresReportService extends ReportService<Auditoria> {
    ...
    private InputStream generatePDFReport() {
        return baseJasperReport.generateReport("controladoresHistorico", getBasicReportMetadata(), auditorias);
    }
    ...
    private InputStream generateCSVReport() {
        ...
        buffer.append("Relatório de Historico de Alteracoes dos Controladores").append(NEW_LINE_SEPARATOR);
