...
public class TrocaPlanosEmModoManualTest extends GerenciadorDeTrocasTest {
    ...
    public void motorTest() throws IOException {
        ...
        assertEquals("Plano Atual Anel 3 - Manual", 1, getPlanoTrocaEfetiva(3, 75).getPosicao().intValue());
        assertEquals("Plano Atual Anel 3 - Manual", ModoOperacaoPlano.MANUAL, getPlanoTrocaEfetiva(3, 75).getModoOperacao());
