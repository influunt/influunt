...
create table modelo_controladores (
  id                            uuid not null,
  fabricante_id                 uuid,
  configuracao_controlador_id   uuid,
  descricao                     varchar(255),
  data_criacao                  timestamp,
  data_atualizacao              timestamp,
...
alter table modelo_controladores drop constraint if exists fk_modelo_controladores_configuracao_controlador_id;
drop index if exists ix_modelo_controladores_configuracao_controlador_id;
