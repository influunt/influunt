...
alter table eventos drop constraint if exists fk_eventos_plano_id;
drop index if exists ix_eventos_plano_id;
...
alter table tabela_horarios drop constraint if exists fk_tabela_horarios_anel_id;
